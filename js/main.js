...
document.getElementById("howto").onclick = function() {
 alert("The goal of the game is to input different generation V Pokemon in attempts to Guess the pokemon correctly. Everytime a guess is inputted, it will tell you if the stats of the hidden pokemon are higher or lower and if you got any other information correct or incorrect. The main goal is to guess the pokemon correctly in as few guesses as possible. Goodluck!  ")
}
